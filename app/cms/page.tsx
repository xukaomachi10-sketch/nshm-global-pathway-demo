    ...
    <div className="min-h-screen bg-[#eef0f3]">
      ...
      <header className="sticky top-0 z-30 flex h-16 items-center gap-3 border-b border-slate-200 bg-white px-4 lg:px-6">
        ...
        <div className="ml-auto flex items-center gap-2">
          <span className="hidden items-center gap-1 text-xs text-slate-400 sm:flex">
            <Check className="h-3.5 w-3.5 text-emerald-600" /> Đã lưu 10:26
          </span>
          ...
          <Card className="sticky top-21 overflow-hidden">
            <div className="border-b border-slate-100 p-4">
              <div className="flex items-center justify-between">
                <h2 className="text-sm font-black text-[#10233f]">Nội dung</h2>
                <button className="rounded-lg bg-[#941b2b] px-3 py-1.5 text-xs font-black text-white">
                  + Bài mới
                </button>
              </div>
            ...
            <div className="max-h-[calc(100vh-180px)] overflow-y-auto">
              {posts.slice(0, 9).map((p, i) => (
                <button
                  ...
                  className={`w-full border-b border-slate-100 p-4 text-left hover:bg-slate-50 ${i === 1 ? "bg-red-50/70" : ""}`}
                >
                  <div className="flex items-center justify-between">
                  ...
                  <p className="mt-2 line-clamp-2 text-xs font-black leading-5 text-[#10233f]">
                    {p.title}
                  </p>
          ...
          <Card className="overflow-hidden">
            ...
            <div className="mx-auto max-w-3xl px-6 py-10 lg:px-10">
              ...
              <textarea
                ...
                rows={2}
                className="font-display mt-4 w-full resize-none border-0 p-0 text-4xl font-bold leading-tight text-[#10233f] outline-none"
              />
              <textarea
              ...
              />
              <div className="relative mt-7 flex h-72 items-center justify-center overflow-hidden rounded-2xl bg-[#10233f]">
                <Image
                  src="/campus-hero.svg"
                  alt="Ảnh bài viết"
                  fill
                ...
                />
                <button className="relative rounded-xl bg-white/90 px-4 py-2 text-xs font-black text-[#10233f] shadow">
              ...
              />
              <div className="my-6 rounded-2xl border-l-4 border-[#d6aa49] bg-[#f7f5f0] p-5">
                <p className="font-display text-xl font-bold leading-8 text-[#10233f]">
              ...
              />
              <div className="mt-6 rounded-2xl border border-dashed border-slate-300 p-5 text-center text-xs font-bold text-slate-400 hover:border-[#941b2b]">
                + Thêm khối nội dung
              </div>
            </div>
          </Card>
        ...
        {panel && (
          <aside>
            <div className="sticky top-21 space-y-4">
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <label className="flex items-center justify-between rounded-xl bg-slate-50 p-3">
                    ...
                    <input
                      type="checkbox"
                      defaultChecked
                      className="h-4 w-4 accent-[#941b2b]"
                    />
                  </label>
                </div>
                <Button
              ...
              <Card className="p-5">
                <div className="flex items-center gap-2">
                  <Sparkles className="h-4 w-4 text-[#941b2b]" />
                  <h3 className="text-sm font-black text-[#10233f]">
                ...
                <div className="mt-4 space-y-3 text-xs">
                  {[
                    ...
                    <div key={x[0]} className="flex justify-between">
                      ...
                      <span
                        className={`font-bold ${x[1] === "Cần bổ sung" ? "text-amber-600" : "text-emerald-600"}`}
                      >
                        {x[1]}
                      </span>
                    </div>
              ...
              <Card className="p-5">
                ...
                <button className="mt-3 text-xs font-black text-[#941b2b]">
                  Chỉnh sửa SEO
                </button>
              </Card>
            </div>
      ...
      >
        <div className="overflow-hidden rounded-2xl border border-slate-200">
          <div className="bg-[#10233f] px-8 py-10 text-white">
          ...
          <div className="p-8">
            ...
            <button className="mt-8 rounded-xl bg-[#d6aa49] px-5 py-3 text-sm font-black text-[#10233f]">
...
function Tool({ icon, text }: { icon: React.ReactElement; text?: string }) {
  return (
    <button className="flex items-center gap-1 rounded-lg px-2.5 py-2 text-xs font-bold text-slate-500 hover:bg-white hover:text-[#10233f] [&_svg]:h-4 [&_svg]:w-4">
      {icon}
      {text}
    </button>
  );
  ...
  return (
    <div className="mt-8">
      <input
        ...
        className="font-display w-full border-0 p-0 text-2xl font-bold text-[#10233f] outline-none"
      />
      <textarea
        defaultValue={text}
        rows={4}
